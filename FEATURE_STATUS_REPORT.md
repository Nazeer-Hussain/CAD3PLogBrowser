...
- ⏳ **C6** - Right-click context menu
  -	All Items in Edit Menu should appear in Context menu as well,context menu should be available on both Call Tree and API Tree nodes, and logview table rows
  - Copy node name
