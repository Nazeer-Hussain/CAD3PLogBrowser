...
{
    /// <summary>
    /// Manages a conversation with OpenAI's Chat Completions API.
    /// </summary>
    public class OpenAIConversation : IAIConversation
    {
        private readonly IAIProvider _provider;
        private readonly List<ChatMessage> _messages;
        private readonly Dictionary<string, object> _metadata;

        public OpenAIConversation(IAIProvider provider)
        {
