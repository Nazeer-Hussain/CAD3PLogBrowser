...
{
    /// <summary>
    /// Manages a conversation with Google's Gemini Generative Language API.
    /// </summary>
    public class GoogleGeminiConversation : IAIConversation
    {
        private readonly IAIProvider _provider;
        private readonly List<ChatMessage> _messages;
        private readonly Dictionary<string, object> _metadata;

        public GoogleGeminiConversation(IAIProvider provider)
        {
